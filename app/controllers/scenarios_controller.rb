class ScenariosController < ApplicationController
  ...
  def scenario_params
    params.require(:scenario).permit(:title, :description, :zip_code, :verb_id, :noun_id, :requester_id, :doer_id, :image, :funding_goal, :event_id, :parent_scenario_id, :is_parent, :is_child, :custom_message)
  end
end
